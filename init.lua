...
--chuboe
--------
--enable spell check by default when opening markdown
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    branch = 'master', -- Pin to master branch (main branch has incompatible API rewrite)
    build = ':TSUpdate',
